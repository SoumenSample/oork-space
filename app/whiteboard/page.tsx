          ...
          <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-xl bg-white/10 px-3 py-2 text-sm font-medium ${isDark?"text-black":"text-white"} backdrop-blur hover:bg-white/20 transition`}
              >
                <ArrowLeft size={16} />
                Whiteboard library
              </button>
